...
const Experience = () => {
  const getIcon = (title) => {
    ...
    if (lowerTitle.includes("rank") || lowerTitle.includes("holder") || lowerTitle.includes("award") || lowerTitle.includes("winner")) return <FaAward className={`text-accent-1 ${iconSize}`} />;
