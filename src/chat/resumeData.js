export const resumeProfile = {
  ...
  skills:
    "My core skills include Python, Java, JavaScript, TypeScript, React.js, Node.js, FastAPI, Django, PostgreSQL, MongoDB, Redis, AWS, Docker, and CI/CD pipelines.",
  angular:
    "I have primarily worked with React.js for frontend development.",
  certifications:
    "I have strong academic foundation and project experience in Software Engineering, Machine Learning, and Cloud platforms.",
  salary: {
    default:
  ...
  visa: {
    status:
      "I am currently an international student on an F-1 visa.",
    stem: "Yes, my degree program is STEM-designated, which makes me eligible for a 24-month STEM OPT extension.",
    sponsorship: "Yes, I will require work visa sponsorship in the future.",
  },
};
